            ...
            <div class="col-md-12">
                <div class="product-content-right">
                    <div class="woocommerce">
                        ...
                        <form action="/curso/Ecommerce/index.php/checkout">
                                ...
                                <tbody>
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-remove">
                                            <a title="Remove this item" class="remove" href="/curso/Ecommerce/index.php/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/remove">×</a> 
                                        </td>

                                        <td class="product-thumbnail">
                                            <a href="/curso/Ecommerce/index.php/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"></a>
                                        </td>

                                        <td class="product-name">
                                            <a href="/curso/Ecommerce/index.php/products/<?php echo htmlspecialchars( $value1["desurl"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["desproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a> 
                                        </td>
                            ...
                            <div class="cart-collaterals">
                                ...
                                <div class="cross-sells">
                                    ...
                                    <div class="coupon">
                                        ...
                                        <input type="submit" formmethod="post" formaction="/curso/Ecommerce/index.php/cart/freight" value="CALCULAR" class="button">
                                    </div>
