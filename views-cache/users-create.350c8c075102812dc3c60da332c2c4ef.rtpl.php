...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="curso/Ecommerce/index.php/admin/users">Usuários</a></li>
    <li class="active"><a href="/curso/Ecommerce/index.php/admin/users/create">Cadastrar</a></li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/curso/Ecommerce/index.php/admin/users/create" method="post">
          <div class="box-body">
