    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <iframe src="/curso/Ecommerce/index.php/boleto/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" name="boleto" frameborder="0" style="width:100%; min-height:1000px; border:1px solid #CCC; padding:20px;"></iframe>
