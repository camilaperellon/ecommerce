...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/curso/Ecommerce/index.php/admin/orders">Pedidos</a></li>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php } ?>
            <!-- form start -->
            <form role="form" action="/curso/Ecommerce/index.php/admin/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status" method="post">
                <div class="box-body">
