<?php if(!class_exists('Rain\Tpl')){exit;}?>    <!-- Declaração do formulário -->  
    ...
    action="https://pagseguro.uol.com.br/v2/checkout/payment.html">  
            ...
            <!-- Campos obrigatórios -->  
            <input name="receiverEmail" type="hidden" value="camila.perellon@gmail.com">  
            <input name="currency" type="hidden" value="BRL">  
      
            <!-- Itens do pagamento (ao menos um item é obrigatório) -->  
            <?php $counter1=-1;  if( isset($products) && ( is_array($products) || $products instanceof Traversable ) && sizeof($products) ) foreach( $products as $key1 => $value1 ){ $counter1++; ?>

            <input name="itemId1" type="hidden" value="<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">  
            <input name="itemDescription1" type="hidden" value="<?php $value1["function"]="utf8_encode(desproduct)"; ?>">  
            <input name="itemAmount1" type="hidden" value="<?php echo htmlspecialchars( $value1["vltotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">  
            <input name="itemQuantity1" type="hidden" value="<?php echo htmlspecialchars( $value1["nrqtd"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">  
            <input name="itemWeight1" type="hidden" value="<?php echo htmlspecialchars( $value1["vlweight"]*1000, ENT_COMPAT, 'UTF-8', FALSE ); ?>">
            <?php } ?>
