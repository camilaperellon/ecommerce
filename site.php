...
$app->post('/checkout', function() {
	...
	header("Location: /curso/Ecommerce/index.php/order/".$order->getidorder()."/pagseguro");
	exit;
	...
	$page = new Page([
	 ...
	 $page->setTpl("payment-pagseguro", [
	 	...
	 	'phone'=>[
	 		...
	 		'number'=>substr($order->getnrphone(), 2, strlen($order->getnrphone())) //strlen - conta quantos tem, e assim pega do 3 número do telefone até o ultimo
	 	]
	 ]);
...
$app->get('/boleto/:idorder', function($idorder) {
	...
	// NÃO ALTERAR!
	$path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "curso" . DIRECTORY_SEPARATOR . "Ecommerce" . DIRECTORY_SEPARATOR . "res" .DIRECTORY_SEPARATOR . "boletophp" . DIRECTORY_SEPARATOR . "include" . DIRECTORY_SEPARATOR;
...
$app->post("/profile/change-password", function(){
	...
	if(!isset($_POST['current_pass']) && $_POST['current_pass'] === ''){
		...
		header("Location: /curso/Ecommerce/index.php/profile/change-password");
		exit;
	}
